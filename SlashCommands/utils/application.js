...
module.exports = {
  ...
  run: async (client, interaction, args) => {
    const server = "740542533657952347";
    if (interaction.guild.id === server) {
      // CHECK BY ID PADARYT TLF FOTKES YRA IR DOCS PARASYTA KAIP IR KAS (EZ CIA VPS 0)
      ...
      return interaction.followUp({ content: "Ši komanda yra galima tik Support serveryje!" });
    }
  },
};
